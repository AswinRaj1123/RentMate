...
export const PropertyDetails = () => {
  return (
    <div className="bg-[#f5f7fa] flex justify-center items-center min-h-screen relative px-4">
      {/* Card Container */}
      <div className="bg-white rounded-lg shadow-md p-6 md:p-8 flex flex-col md:flex-row gap-8 max-w-5xl w-full">
        ...
        <div className="flex flex-col gap-4 md:w-1/2">
          ...
          <div className="flex gap-4">
            <img
              className="w-1/2 h-[90px] md:h-[110px] object-cover rounded"
              alt="Property view 1"
              src={image2}
            />
            <img
      ...
      <img
        className="absolute bottom-6 right-6 w-48 md:w-72 opacity-70"
        alt="Background"
